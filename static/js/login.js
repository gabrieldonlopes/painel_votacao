document.addEventListener('DOMContentLoaded', function() {
    ...
    const passwordInputs = document.querySelectorAll('input[type="password"], input[type="admin_password"]');
    
    // Alternar visibilidade da senha para ambos os campos
    togglePasswordButtons.forEach((button, index) => {
        button.addEventListener('click', function() {
            // Encontrar o input correspondente (o input anterior ao botão no mesmo container)
